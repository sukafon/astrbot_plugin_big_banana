...
- `/lm删除 <触发词>` 快捷删除预设提示词
- `/lm列表` 查看所有预设提示词名称列表
- `/lm详情 <触发词>` 查看该预设的完整提示词
- `/lm白名单添加 <用户/群组> <ID/SID>` 可通过命令增加群组和用户白名单
- `/lm白名单删除 <用户/群组> <ID/SID>` 可通过命令删除群组和用户白名单
